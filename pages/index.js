    ...
    <div className={styles.container}>
      ...
      <div className='search-bar'>
        <div className='content-title'>
          <p className='pb-05'>Mọi người vui lòng nhập mã sản phẩm vào ô tìm kiếm</p>
        </div>
                ...
                {listProduct.map((item, index) => (
                  <div className='product-item' key={index}>
                    ...
                    <div className='product-text'>
                      {item.sameproduct && <h6 className='mt-5'>Similar products</h6>}
                      <p>
                        Mã SP: <span className='code'>{item.name}</span>
                      </p>
                      {item.shoppelink && (
                        <>
                          <a href={item.shoppelink} target='_blank' className='custom-button'>
                            Mua ngay trên Shoppe
                          </a>
                        </>
                      )}
                      {item.usalink && (
